...
public class MPlankRotation : MonoBehaviour
{
    ...
    private MCollisionDetection collisionDetection;
    private MPivotAssignment pivotAssignment;
    private MPlankCollisionDetection plankCollisionDetection;
    private MPlankConnection plankConnection;
    ...
    private void Start()
    {
        ...
        collisionDetection = GetComponent<MCollisionDetection>();
        pivotAssignment = GetComponentInChildren<MPivotAssignment>();
        plankCollisionDetection = GetComponentInChildren<MPlankCollisionDetection>();
        plankConnection = GetComponent<MPlankConnection>();
    }
